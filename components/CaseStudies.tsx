...
const PREDICTABLE_TABS = [
  { id: 0, title: "We morph into you", content: { title: "We don't turn up with clever new ideas about your market.", desc: "Your team already knows which angles land and which objections come up on every call. We sit with your closers, take what is already working, and put two dedicated SDRs behind it. The SDRs are reskinned in your brand, so a prospect experiences one company rather than an agency calling on your behalf.", extra: "We integrate into your CRM, calendars and reporting so nothing happens in a corner your team cannot see.", footer: "The honest version: on the first call we tell clients we don't do lots differently. We just do the qualification properly." } },
  { id: 1, title: "Qualified out, not just in", content: { title: "We book fewer meetings than the competition, deliberately.", desc: "On the call we push back. We test the partner objection, we test the timing, we test whether there is real budget behind the interest. A prospect who folds under that was never going to close, and finding out now costs us a booking instead of costing your closer an hour.", extra: "A meeting only counts when it took place and the account fits your ICP. Booked-but-never-sat is not a meeting.", footer: "Your senior people cost £90-100k. The cheapest thing we can do is keep slop off their calendar." } },
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-5xl md:text-6xl font-black text-[#0d2b23] mb-8 leading-tight tracking-tighter">
            The work behind a meeting <span className="text-[#2e4841]">worth sitting in</span>
          </h2>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="bg-white border border-slate-100 shadow-sm rounded-[56px] p-12 md:p-24 overflow-hidden relative text-[#0d2b23]">
          <div className="text-center mb-24 max-w-3xl mx-auto">
            ...
            <h2 className="text-5xl font-black mb-8 leading-tight tracking-tighter">The stack sits inside the retainer</h2>
            <p className="text-[#61756f] text-lg font-medium leading-relaxed">
